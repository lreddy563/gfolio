    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <a className="drop-link" href="mailto:lreddy563@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/lreddy563">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/n-lohidasu-reddy/">
            <img
              src={li}
              alt=""
            />
